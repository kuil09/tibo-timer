...
"$LLAMA_SERVER" -m "$MODEL_PATH" -ngl 0 -t 4 -c 4096 --parallel 1 --host 127.0.0.1 --port 8080 --jinja --chat-template-kwargs '{"enable_thinking":false}' > .cache/evaluation/server.log 2>&1 &
