...
await writeJson(`.cache/evaluation/${process.env.MODEL_ID}-benchmark.json`,{model:process.env.MODEL_ID,prepared,startup_seconds:startup,rounds,cold_total_seconds:cold,server_peak_rss_kib:peak,
