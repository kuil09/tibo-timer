...
for (let attempt = 0; attempt < 5; attempt++) {
  try {
    for (const path of ['version.json', 'status.json', 'index.html', 'app.mjs', 'view.mjs', 'tibo-ascii.mjs', 'tibo-ascii-data.mjs', 'style.css']) {
    ...
    console.log('Verified deployed HTML, JavaScript, CSS, ASCII portrait, version and public status against this build.');
    break;
  } catch (error) {
